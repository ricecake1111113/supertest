function o(t) {
    ...
    "152b": function(t, e, s) {
        ...
        const n = ["EMAIL", "TEXT", "PASSWORD", "FILE"]
          , r = t => {
            ...
            let a = !0;
            ("INPUT" === s && n.includes(r) || "TEXTAREA" === s) && (a = e.readOnly || e.disabled),
            a && t.preventDefault()
        }
          , a = t => {
    ...
    "22a7": function(t, e, s) {
        ...
        var i = s("c2e2")
          , n = s("ded8");
        const r = t => t.reduce( (t, e) => (t[e] = !0,
        t), {});
        class a {
            analyze(t, e) {
                const {totalProgress: s, timestamps: i} = this.analyzeHistory(t, e)
                  , {base: n, final: a} = this.analyzeProgress(t, s)
            ...
            analyzeHistory(t, e) {
                const s = {}
                  , r = [];
                return e.forEach( ({mother: e, father: a, timestamp: o}) => {
    ...
    "3b56": function(t, e, s) {
        ...
        class E {
            ...
            initSaveTriggers() {
                f.forEach(t => r["a"].on(t, this.save)),
    ...
    "5c57": function(t, e, s) {
        ...
        const K = {
          ...
          , z = {
            ...
            mutations: {
                ...
                STATIC_DROPPABLE_UPDATE(t, {id: e, width: s, height: i, x: n, y: r}) {
                    const a = t.static[e];
                    a.dimensions.width = s,
                    a.dimensions.height = i,
                    a.position.x = n,
                    a.position.y = r
                },
          ...
          , ct = {
            ...
            actions: {
                ...
                mixBase({commit: t, dispatch: e, getters: s}, {children: i, positions: n}) {
                    ...
                    t("MIX_SET_CHILDREN", r),
                    t("MIX_SET_BASE_CHILDREN", a),
                    e("progressNewBase", a)
                },
          ...
          , gt = {
            ...
            actions: {
                libraryReload({commit: t, getters: e}) {
                    ...
                    s = "timestamp" === e.librarySortBy ? Object(mt["b"])(e.total, i) : Object(mt["a"])(e.elements, i),
                    t("LIBRARY_RELOAD", s)
                },
        ...
        const yt = {
          ...
          , vt = {
            ...
            mutations: {
                PROGRESS_ANALYZED(t, {progress: e, base: s, final: i, primes: n, timestamps: a}) {
                    t.progress = e,
                    t.base = s,
                    t.prime = n,
                    t.final = i,
                    t.total = a,
                    Object(r["A"])("progress", "analyzed", t)
                },
                PROGRESS_NEW(t, e) {
          ...
          , Ht = {
            ...
            actions: {
                popupToggle({dispatch: t, getters: e}, s) {
                    ...
                    $()( () => t("popupShow", s))) : t("popupHide", void 0)
                },
                popupShow({commit: t, dispatch: e}, s) {
                    s === Mt["ENCYCLOPEDIA"] && e("encyclopediaShow"),
                    t("UI_POPUP_SHOW", s),
                    jt["a"].onShow(s)
                },
                ...
                popupHide({commit: t, getters: e}, {hideOverlay: s=!0}={}) {
                    null !== e.popup && (jt["a"].onHide(e.popup),
                    t("UI_POPUP_HIDE", s))
                }
            },
            mutations: {
          ...
          , Wt = {
            ...
            actions: {
                ...
                workspaceRemoveUnderLibrary({commit: t, getters: e}) {
                    const {position: {x: s}} = e.droppableStaticById(B["e"])
                ...
                workspaceHandleMixResult({dispatch: t, getters: e}, {removeParents: s=!0}={}) {
                    ...
                    r.length && t("workspaceFinalAdd", r),
                    a.length && t("workspaceExhaustedAdd", a),
                    $()( () => t("libraryReload"))
                },
    ...
    b10a: function(t, e, s) {
        ...
        class d {
            init(t) {
                this.$store = t,
                c["a"].on("ELEMENT_CLONE", t => this.onCloned(t))
            }
            onCloned(t) {
            ...
            getCloneDirections(t, e) {
                let s = 1
                  , i = -1;
                return t.x + e.width + h >= this.workspacePositionRight && (s *= -1),
                t.y <= h && (i *= -1),
                {
                    x: s,
                    y: i
    ...
    c2e2: function(t, e, s) {
        ...
        function n(t, [e,s], n) {
            const r = t[n];
            if (!Object(i["a"])(t, n) || !Object(i["b"])(r))
                return [];
    ...
    cd49: function(t, e, s) {
        ...
        class D {
            constructor() {
                ...
                this.initContent = async () => {
                    ...
                    this.$store.getters.sessionsCount <= P)
                        return;
                    const t = await this.load()
            ...
            load() {
                const t = async () => (await Object(o["c"])(L),
                this.cached);
            ...
            fetch() {
                return null !== this._promise ? this._promise : (this._promise = Object(o["d"])(_),
                this._promise)
            }
            get storage() {
                return Object(b["a"])(x) || {}
        ...
        var j = s("b10a");
        const $ = {
            addToWorkspace: ({id: t}) => j["a"].addToWorkspace(t)
        };
        var H = $
          , B = s("152b");
        const F = (t, e, s) => ({
          ...
          , G = [F("ENCYCLOPEDIA_ELEMENTS", "elements", {
            ...
            callback: async t => {
                Object(B["c"])(document.body, "longpress"),
                await Object(o["c"])(60),
                t.dispatch("popupShow", y["ENCYCLOPEDIA"])
            }
        ...
        class W {
            ...
            initCommands() {
                U.forEach(t => {
                    g["a"].on(t.trigger, e => {
                        let s = {};
                        M(t.prepare) && (s = t.prepare(this.$store, e)),
                        this.post(t.command, s),
                        M(t.callback) && t.callback(this.$store)
                    }
                    )
                }
                )
            ...
            onMessage({command: t, data: e}) {
                ...
                "ready" !== t ? H.hasOwnProperty(t) && H[t](e) : this.onReady()
            }
            onReady() {
                this.log("ready"),
                this.loaded = !0,
          ...
          , tt = [{
            ...
            hide() {
                return new Promise(t => {
                    const e = () => {
                        Z().length < 2 || (g["a"].off("ELEMENT_DROP", e),
                        g["a"].off("MIX_NEW", e),
                        t())
                    }
                    ;
        ...
        class et {
            constructor() {
                ...
                this.reset = () => {
                    this.hide(),
                    a["a"].dispatch("tutorialsFinished"),
            ...
            show(t) {
                a["a"].dispatch("tutorialShow", t.name),
        ...
        const yt = () => {
          ...
          , wt = t => {
            t.simulated || "mousedown" === t.type && t.button !== ot || null !== Et && Et !== t.type || null !== gt && gt !== t.target || lt(t) && (gt = t.target,
            Et = t.type,
            clearTimeout(pt),
            pt = window.setTimeout(vt, dt),
            0 !== mt || bt || (bt = {
                x: t.pageX,
                y: t.pageY
            }))
          ...
          , It = t => {
            if (t.simulated)
                return;
            if ("mouseup" === t.type && t.button !== ot)
                return;
            if (null !== ft && ft !== t.type)
                return;
            if (null !== gt && gt !== t.target)
                return;
            if (!lt(t))
                return;
            if (!bt)
          ...
          , Ot = 1e3
          , At = 2;
        let St, Tt = null, _t = null, xt = null, Pt = null, Ct = null;
        const Lt = () => {
            document.removeEventListener(`${Ct}move`, St, !1),
            clearTimeout(_t),
            _t = null,
            Tt = null,
            Ct = null
          ...
          , Nt = t => {
            t.simulated || (null === Ct || t.type.includes(Ct)) && ("mousedown" !== t.type && "pointerdown" !== t.type || t.button === ot) && lt(t) && (Tt = t.target,
            Ct = t.type.replace("down", "").replace("start", ""),
            xt = {
                x: t.pageX,
                y: t.pageY
            },
        ...
        class Ht {
            ...
            async onLibraryDistanceDragged(t, e, s, i, n) {
                ...
                c && this.getWorkspaceBoxElement(a) || (this.$store.commit("DRAGGABLE_HELPER_RESET"),
                this.$store.dispatch("draggableHelperAdd", !0),
                a = this.$store.getters.draggableHelperId,
                c = this.$store.getters.draggableHelperElement,
                await Object(o["r"])()),
            ...
            simulateStartDrag({id: t, dragPoint: {x: e, y: s}, startEventType: i}) {
                ...
                const a = r.__vue__;
                a && (a.updateDraggablePosition(),
                a.draggable.dragStart(n, n))
            }
        ...
        class pe {
            constructor(t, e) {
                ...
                this.setVolume(this.sfx.gain, de),
                this.music = this.context.createGain(),
                this.setVolume(this.music.gain, me),
            ...
            initWatchers() {
                this.$store.watch( (t, e) => e.playMusic, t => this[t ? "unmute" : "mute"](te)),
                this.$store.watch( (t, e) => e.playSfx, t => this[t ? "unmute" : "mute"](Zt))
            }
            mute(t) {
                const e = t === te ? me : he;
            ...
            async fadeInMusic(t=oe, e=ue) {
                if (this.canPlay(te)) {
                    ...
                    this.music.gain.value !== s && this.setVolume(this.music.gain, me),
                    this.music.gain.exponentialRampToValueAtTime(s, this.context.currentTime + t)
                }
                await Object(o["c"])(1e3 * t)
            }
            async fadeOutMusic(t=oe) {
                this.music.gain.exponentialRampToValueAtTime(me, this.context.currentTime + t),
                await Object(o["c"])(1e3 * t)
            }
            canPlay(t) {
        ...
        const _e = 6e4
          ...
          , Le = () => {
            let t = 0
              ...
              , s = 0;
            const i = Date.now();
            return a["a"].getters.history.forEach( ({timestamp: n}) => {
                const r = i - n;
          ...
          , De = () => {
            const {short: t, long: e, finish: s} = Le()
              , i = 3 * t + 2 * e + s;
            return i > Ce ? ne : ie
        }
        ;
        ...
        class Me {
            ...
            calculateRandomNext() {
                ...
                if (!this.current)
                    return se;
                if (this.current.type === te && this.current.mood === ne)
            ...
            addToHistory(t) {
                ...
                this.history.length > Ne && this.history.pop()
            }
            getSound(t) {
        ...
        class He {
            ...
            play(t) {
                ...
                this.current !== se ? (this.playSource(e),
                ...
                e.fadeIn ? this.volume.fadeInMusic(e.fadeIn, e.volume) : this.volume.unmute(te, e.volume)) : window.setTimeout( () => {
            ...
            isValid(t) {
                return !!t && (!this.isPlaying && !this.isHidden && (this.volume.canPlay(te) && this.$store.getters.isGameActive ? !!t.buffer || (this.base.sounds.load(t).then( () => this.play(t.name)).catch( () => null),
            ...
            async onShow() {
                ...
                this.currentSound && !this.currentSound.fadeIn && this.volume.fadeInMusic($e, this.currentSound.volume))
            }
            async onHide() {
                this.isPlaying && (Object(o["q"])("music", "stop on hide", this.current),
                await this.volume.fadeOutMusic($e),
                await this.pause(),
        ...
        class Fe {
            ...
            init(t) {
                ...
                this.player = new Be(this,this.context,t),
                this.sounds = new ve(this.context),
                this.volume = new ge(this.context,t),
                this.sfx = new Ae(this.playSFX),
                this.music = new je(this,this.playMusic),
                g["a"].once("AUDIO_EXTENSION", () => {
                    this.sounds.add(Zt, this.sfx.sounds),
                    this.sounds.add(te, this.music.sounds),
        ...
        const We = {
          ...
          , qe = [Ve("ANALYTICS_INIT", ({send: t}) => t("metrics", "game_ready", null, null, null, !0)), Ve("PLAY", ({send: t}) => t("metrics", "play_clicked")), Ve("MIX_NEW", async ({send: t, $store: e}) => {
            await Object(o["c"])(500);
            const s = e.getters.totalProgress
              , i = ze(s);
            i && t("metrics", "total_progress", i, +i)
        }
        ), Ve("TUTORIALS_FINISHED", ({send: t}) => t("metrics", "tutorials_finished")), Ve("HINTS_CLICKED", ({send: t, $store: e}) => {
            t("metrics", "hints_clicked"),
            t("user", "opens hints - fails streak", e.getters.sessionFailStreak)
        }
        ), Ve("UNLOAD", ({send: t, $store: e}) => t("user", "leaves - fails streak", e.getters.sessionFailStreak))];
        var Qe = qe;
        const Je = [Ve("ANALYTICS_INIT", ({set: t, $store: e}) => {
        ...
        ), Ve("MIX_NEW", async ({set: t, $store: e}) => {
            await Object(o["c"])(500);
        ...
        ), Ve("LOGGED_IN", ({set: t}) => t("logged_in", !0)), Ve("NOT_LOGGED_IN", ({set: t}) => t("logged_in", !1)), Ve("TUTORIALS_FINISHED", ({set: t}) => t("engagement", "tutorials_finished")), Ve("TUTORIALS_PROGRESS", ({set: t}, {type: e, name: s}) => t("engagement", `tutorial_${e}_${s}`)), Ve("ANIMATION_NEW_POP", ({set: t, $store: e}) => {
            e.getters.totalProgress > 5 || t("engagement", "first_new_animation_pop")
        }
        ), Ve("ANIMATION_NEW_END", ({set: t, $store: e}) => {
            e.getters.totalProgress > 5 || t("engagement", "first_new_animation_end")
        }
        ), Ve("HINTS_CLICKED", ({set: t}) => t("engagement", "hints_clicked")), Ve("GAME_ENDED", ({set: t}) => t("engagement", "game_ended")), Ve("GAME_COMPLETED", ({set: t}) => t("engagement", "game_completed"))]
          , Ze = [Xe(t => t.playMusic, ({set: t}, e) => t("music_active", e)), Xe(t => t.playSfx, ({set: t}, e) => t("sfx_active", e))]
          , ts = [...Je, ...Ze];
        var es = ts;
        const ss = [Ve("GAME_READY", ({timing: t}) => t("ready", Math.round(window.performance.now())))];
        var is = ss;
        const ns = [...Qe, ...es, ...is];
        var rs = ns;
        ...
        class cs {
            constructor() {
                ...
                this.send = (t, e, s=null, i=null, n=null, r=!1) => {
                    if (!window.ga)
                        return;
                    const a = {};
                    r && (a.nonInteraction = !0),
                    null === n ? window.ga("send", "event", t, e, s, i, a) : window.ga("send", "event", t, e, n, a),
                    this.logger("[EVENT]", t, e, s, i, n, a)
                }
                ,
                this.set = (t, e) => {
                    window.ga && (window.ga("set", os[t], e),
                    this.logger("[SET]", t, e))
                }
                ,
                this.sendTiming = (t, e) => {
            ...
            async init(t) {
                this.$store = t,
                document.addEventListener(at["c"], () => this.send("metrics", "not_ready_play_click", "timing", window.performance.now(), null, !0)),
                await g["a"].onReady(),
                this.setup()
            }
            setupTracker() {
        ...
        class Ws {
            ...
            dragStart(t, e) {
                Bt.isDragging || (t.cancelable && t.preventDefault(),
                this.throttle = !1,
                this.helper = null,
                this.isDragging = !0,
                ...
                this._bindEvents(Us[this.startEventType]),
            ...
            dragEnd(t) {
                ...
                this.pointerIdentifier = null,
                this._unbindEvents(),
                this.isWorkspace && (this.helper && "none" !== this.helper.style.display && Fs && (this.helper.style[Fs] = "",
                this.setLeftTop()),
                this.hasOwnProperty("onDragEnd") && "function" === typeof this.onDragEnd && this.onDragEnd(this),
                Bt.onDragEnd(this.position, t.simulated || !1))
            }
            animate() {
                if (this.throttle = !1,
                !this.isDragging)
        ...
        var ii = fs["a"].extend({
            ...
            methods: {
                ...
                addTransitionListener(t) {
                    t && !this.listenerAdded && (this.$refs.element.addEventListener(hs["b"], this.onTransitionEnd, !1),
                ...
                onWorkspaceAnimationEnd() {
                    this.$store.dispatch("animationReset"),
                    this.$refs.element.removeEventListener(hs["b"], this.onTransitionEnd),
        ...
        var Li = fs["a"].extend({
            ...
            watch: {
                ...
                async inArtMode(t) {
                    t && (await $t["a"].onInit(),
                    $t["a"].handler && $t["a"].handler.refresh())
                },
                startIndex(t) {
                    this._startIndex = t
                },
            ...
            methods: {
                async initScroll() {
                    await $t["a"].onInit(),
                    await $t["a"].handler.reinitialize(),
                    this.handleScroll = this.handleScroll.bind(this),
                    $t["a"].handler.onScroll(t => {
                        this.lastY = t.y,
        ...
        var Mi = fs["a"].extend({
            ...
            mounted() {
                this.checkUnderLibrary = hi()(this.checkUnderLibrary.bind(this), v["a"]),
            ...
            methods: {
                ...
                updateHeights() {
                    const t = this.$refs.scroller.$children;
                    if ($t["a"].isNative || !this.$refs.element.firstChild)
                        return !1;
                    if (t.length < 2)
                        return !1;
                    const e = t[1].$el
                ...
                async initScrollRefresher() {
                    await $t["a"].onInit(),
                    $t["a"].isNative || (this.updateHeights(),
                ...
                refreshScroll() {
                    ...
                    $t["a"].handler && $t["a"].handler.refresh && $t["a"].handler.refresh(e)
                },
                libraryRendered() {
                    return new Promise(t => {
        ...
        function Vi(t, e) {
            ...
            if (Object.getOwnPropertySymbols) {
                ...
                for (i = 0; i < r.length; i++)
                    s = r[i],
                    e.indexOf(s) >= 0 || Object.prototype.propertyIsEnumerable.call(t, s) && (n[s] = t[s])
            }
            return n
        }
        function Xi(t, e) {
            if (null == t)
                return {};
            var s, i, n = {}, r = Object.keys(t);
            for (i = 0; i < r.length; i++)
                s = r[i],
                e.indexOf(s) >= 0 || (n[s] = t[s]);
            return n
        }
        var qi = {
            functional: !0,
          ...
          , rn = fs["a"].extend({
            ...
            methods: {
                ...
                onKeyUp(t) {
                    ...
                    if (this.isActive && t.keyCode === Gi["d"])
        ...
        var sr = fs["a"].extend({
          ...
          , ar = fs["a"].extend({
            ...
            methods: {
                ...
                toggleSettings() {
                    this.isPopupWithNameActive(y["SETTINGS"]) ? g["a"].emit("SETTINGS_HIDE") : g["a"].emit("SETTINGS_SHOW"),
                    this.toggle(y["SETTINGS"])
                },
                toggleEncyclopedia() {
                ...
                toggleHints() {
                    this.isPopupWithNameActive(y["SYNC"]) || (window.open(v["f"], "_blank"),
                    this.onHintsClick())
                },
                onHintsClick() {
        ...
        var fr = fs["a"].extend({
            ...
            watch: {
                tutorialTextCurrent(t) {
                    if (!t)
                        return;
                    let e;
                    e = Object(ur["b"])(t.text) ? t.text : t.text(this.$store.getters),
                    this.textCopy = e
                }
            },
            methods: {
          ...
          , Lr = Cr
          , Dr = (s("6294"),
        Object(Ls["a"])(Lr, ps, gs, !1, null, null, null))
          , Rr = Dr.exports;
        r["a"].config.productionTip = !1,
        r["a"].config.devtools = !1,
        r["a"].config.debug = !1,
        r["a"].config.silent = !0,
        r["a"].config.performance = !1,
        new r["a"]({
            store: a["a"],
            el: "#app",
            render: t => t(Rr)
        ...
        class o {
            ...
            isOutsideWorkspace() {
                ...
                if (!e)
                    return !1;
                const {x: s, y: n} = e
                  , {width: r, height: a} = this.workspaceBoxDimensions;
    ...
    d257: function(t, e, s) {
        ...
        const n = (t, e="animationend") => new Promise(s => {
          ...
          , a = (t, e) => (t.addEventListener(i["a"], e, !1),
        () => t.removeEventListener(i["a"], e))
          , o = (t, e) => a(t, ({animationName: t}) => e(t))
